...
@allure.description("Тесты на странице админки")
@pytest.mark.administration_page
class TestAdministrationPage:
    @allure.title("Инпут ввода мейла отображается на странице")
    @pytest.mark.parametrize("presta_shop_url", [AdministrationPage.URL], indirect=True)
    def test_email_input_is_desplayed(self, driver):
    ...
    @allure.title("Инпут пароля отображается на странице")
    @pytest.mark.parametrize("presta_shop_url", [AdministrationPage.URL], indirect=True)
    def test_password_input_is_desplayed(self, driver):
    ...
    @allure.title("Кнопка входа отображается на странице")
    @pytest.mark.parametrize("presta_shop_url", [AdministrationPage.URL], indirect=True)
    def test_login_button_is_desplayed(self, driver):
    ...
    @allure.title("Нажать на forgot password")
    @pytest.mark.parametrize("presta_shop_url", [AdministrationPage.URL], indirect=True)
    def test_click_to_forgot_pass(self, driver):
    ...
    @allure.title("Отображается текст stay logged in")
    @pytest.mark.parametrize("presta_shop_url", [AdministrationPage.URL], indirect=True)
    def test_stay_logged_in(self, driver):
    ...
    def test_login(self, driver):
        ...
        assert_element_text_equals(
            AdministrationMainPage(driver).dashboard_header.text,
            expected_dashboard_header,
        )
    ...
    @allure.title("Логаут из админки")
    def test_logout(self, admin_login):
    ...
    @allure.title("Добавить новый продукт в админку")
    def test_add_new_product(self, admin_login):
        admin_main_page = AdministrationMainPage(admin_login)
    ...
    def test_delete_product(self, product_admin_driver):
